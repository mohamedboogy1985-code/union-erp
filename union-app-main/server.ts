...
import { aiService, AI_PRIMARY_MODEL } from './server/services/ai.service.js';
...
async function startServer() {
  ...
  // ==========================================
  // 11. AI FINANCIAL ASSISTANT (Gemini Server API)
  // ==========================================
  ...
  // ============ المساعد الذكي العام العائم (شامل لكل الشاشات) ============
  ...
  app.post('/api/ai/execute-entry', (req: Request, res: Response) => {
    ...
    try {
      ...
      // ترحيل مباشر بعد التأكيد (أثبتت المراجعة أن الترحيل بلا مشرف مقبول هنا)
      // يبقى معيار فصل المهام (SoD) ساريًا في المسار اليدوي، لكن مسار المساعد الذكي
      // يعتبر تأكيد المستخدم بمثابة اعتماد صريح على مسودة وُلّدت من الذكاء الاصطناعي.
  ...
  // ==========================================
  // 11b. SMART AGENT: DATA LINKING + KNOWLEDGE BASE (IMPROVEMENTS 2.1 / 2.2)
  // ==========================================
  ...
  // ==========================================
  // 11c. ADVANCED VOICE PROCESSOR (IMPROVEMENTS 4.1)
  // ==========================================
